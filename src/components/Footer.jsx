...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-gray-200 w-full">
      <div className="flex flex-wrap justify-between gap-12 px-16 py-14">
            ...
            <div className="flex gap-2">
              {socialIcons.map(({ icon, label }) => (
                <a key={label} href="#" aria-label={label}
                  className="flex items-center justify-center w-9 h-9 rounded-full bg-gray-900 text-white hover:bg-yellow-500 transition-colors">
                  {icon}
                </a>
              ))}
            </div>
          ...
          <div className="flex gap-12">
            <ul className="flex flex-col gap-3">
              {sitemapLinks1.map((link) => (
                <li key={link}><a href="#" className="text-sm text-gray-500 hover:text-yellow-500">{link}</a></li>
              ))}
            </ul>
            <ul className="flex flex-col gap-3">
      ...
      {/* Bottom */}
      <div className="border-t border-gray-200 px-16 py-5 flex flex-wrap items-center justify-between gap-4">
        ...
        <p className="text-xs text-gray-400">
          ...
          <a href="#" className="hover:text-yellow-500">Nuestros Chefs</a> · <a href="#" className="hover:text-yellow-500">Configurar cookies</a>
        </p>
      </div>
    </footer>
  );
